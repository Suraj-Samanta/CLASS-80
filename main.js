...
function sorting()
{
    ...
    for (var k = 0; k < lenght_of_name_of_student_array; k++)
    {
        display_student_array1.push("<h4>NAME "+ name_of_the_student_array[k] + "</h4>");
      console.log(display_student_array1);  
    }
    console.log(display_student_array1);
    document.getElementById("display_name_with_commas").innerHTML= display_student_array1;
